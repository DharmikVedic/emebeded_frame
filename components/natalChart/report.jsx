import {
  ...
  modes,
  moonPhase,
} from "../natalChart/icon";
import {
  AspectCard,
  FetureCard,
  PlanetHouse,
  ProfileDetailCard2,
} from "../natalChart/utils";

import { FetchApi } from "@/components/utils/fetchAPI";
import React, { useEffect, useState } from "react";
import { PlanetCard2 } from "./utils";
...
export default function NatalCalculator2({ userdata, jsonData }) {
  const [detail, setdetail] = useState(d);
  const { deleteuserdata } = useForm();
      ...
      <div className="px-5 ">
        <div className="flex flex-col gap-10">
          <div className="max-w-3xl md:pb-5 mx-auto flex flex-col gap-5">
            ...
            {/* </DynamicText> */}
            <Paragraph
              style="text-para md:text-lg text-center"
              text={jsonData?.content?.description}
            />
          </div>

          <div className="flex md:flex-row flex-col items-center gap-14 md:gap-20">
          ...
          <>
            ...
            <div className="md:pt-20 pt-10">
              ...
              <div className="md:py-20 py-14">
                <PlanetCard2 title="Natal Planets" response={detail.planets} />
              </div>
              <PlanetHouse title="Natal Houses" detail={detail.houses} />
